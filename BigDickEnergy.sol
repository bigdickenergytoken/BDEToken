...
⠁⠄⠄⠄⠄⠄⠐⡐⠱⡱⣻⡻⣝⣮⣟⣿⣻⣟⣻⡺⣊
 ...
 TOKENOMICS:
 20% Tax on each transaction
    -> 5% tax on each transaction goes to liquidity pool to stabilize price
    -> 15% tax on each transaction (buy, sale, transfer) is redistributed to existing holders to juice your BDE
 
 Time to watch your ..... grow like your mom has never seen before. Big gains only
...
contract BigDickEnergy is Context, IERC20, Ownable {
    ...
    string private _name = "BigDickEnergy";
    string private _symbol = "BIGDICKENERGY";
    ...
    uint256 constant numTokensSellToAddToLiquidity = 1000000  * 10**9;
